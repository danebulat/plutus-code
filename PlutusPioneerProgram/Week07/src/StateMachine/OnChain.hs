...
module StateMachine.OnChain where
...
import qualified Plutus.Script.Utils.V1.Typed.Scripts.Validators as UtilsTypeScriptsV1
...
gameDatum :: Maybe LedgerApiV1.Datum -> Maybe GameDatum
gameDatum md = do
  LedgerApiV1.Datum d <- md
...
typedGameValidator :: Game -> UtilsTypeScriptsV1.TypedValidator Gaming
typedGameValidator game = UtilsTypeScriptsV1.mkTypedValidator @Gaming
  ...
  where
    wrap = UtilsTypeScriptsV1.mkUntypedValidator @GameDatum @GameRedeemer

gameValidator :: Game -> LedgerApiV1.Validator
